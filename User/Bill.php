...
$selqry="select * from tbl_cart c inner join tbl_booking b on b.booking_id=c.booking_id inner join tbl_user u on u.user_id=b.user_id inner join tbl_mobile p on p.mobile_id=c.mobile_id inner join tbl_mobiledetails m on p.mobile_id=m.mobile_id inner join tbl_company r on p.company_id=r.company_id where c.cart_id='".$_GET["id"]."'";
        ...
        <table style="width: 100%; table-layout: fixed">
          <tr>
            ...
            >
              ...
              >
              	<span
                style="color:#F93;font-size:56px"></span>
